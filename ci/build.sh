...
COMPONENTS['py']='OPENVDB_BUILD_PYTHON_MODULE'
COMPONENTS['test']='OPENVDB_BUILD_UNITTESTS'
COMPONENTS['bin']='OPENVDB_BUILD_VDB_PRINT,OPENVDB_BUILD_VDB_LOD,OPENVDB_BUILD_VDB_VIEW,OPENVDB_BUILD_VDB_RENDER,OPENVDB_BUILD_VDB_TOOL,OPENVDB_BUILD_VDB_TOOL_UNITTESTS'
...
COMPONENTS['ax']='OPENVDB_BUILD_AX'
...
COMPONENTS['nanotools']='NANOVDB_BUILD_EXAMPLES,NANOVDB_BUILD_BENCHMARK,NANOVDB_BUILD_TOOLS'
